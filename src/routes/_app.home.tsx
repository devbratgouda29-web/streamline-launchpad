...
import { getFracturedItems, restoreItem, subscribe as subscribeRevision, type RevisionItem } from "@/lib/revision-engine";
...
function HomePage() {
  ...
  useEffect(() => {
    ...
    const u = subscribeRevision(() => setFractured(getFracturedItems()));
    return () => { u(); };
  }, []);
